...
{
    public class StiClusteredColumnSeriesAnimationGeom : StiAnimationGeom
    {
        ...
        public override StiGeomType Type
        {
            get
            {
                return StiGeomType.AnimationColumn;
            }
        }
        #endregion

        public StiClusteredColumnSeriesAnimationGeom(object background, StiPenGeom borderPen, object rect, TimeSpan duration, TimeSpan? beginTime, bool upMove, string toolTip, object tag) : base(duration, beginTime)
        {
